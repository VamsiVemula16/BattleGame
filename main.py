...
player1 = Person("Player1", 4602, 122, 60, 34, player_spells, player_items)
player2 = Person("Player2", 4260, 178, 60, 34, player_spells, player_items)
player3 = Person("Player3", 3630, 164, 60, 34, player_spells, player_items)
enemy = Person("Enemy", 11200, 625, 505, 25, [], [])
